...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    NHViewController * viewController = [segue destinationViewController];
    NSParameterAssert([viewController isKindOfClass:[NHViewController class]]);
    viewController.testName = segue.identifier;
}
